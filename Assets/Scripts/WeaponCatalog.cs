...
namespace FpsManager
{
 public static class WeaponCatalog
 {
  ...
  static readonly float[] ArmorRatio={.94f,1.01f,1.15f,1.812f,1.823f,1.864f,1.15f,1.2f,1.25f,1.26f,1.3f,1.55f,1.4f,1.55f,1.4f,1.8f,2f,1.95f};
  ...
  public static WeaponProfile Find(string id)
  {
   ...
   return new WeaponProfile{id=id,recoilPerShot=id=="awp"?1f:id=="desert_eagle"?.8f:i<6?.3f:i<11?.12f:.18f,damage=Body[i],armorRatio=ArmorRatio[i],headMultiplier=4,fireInterval=Interval[i],magazineSize=Magazine[i],reloadSeconds=id=="awp"?3.5f:2.2f,baseSpreadDegrees=id=="awp"?.65f:3};
  }
